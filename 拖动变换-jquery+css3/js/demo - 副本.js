(function () {
	var main = {
			...
			$drag: function(){
				...
				function changeImg(obj,img){obj.attr("src","templates/public/images/beauty/"+ img +"");}
				function changeBg(obj,bg){obj.attr("style","background-image:url(templates/public/images/beauty/"+ bg +")");}
